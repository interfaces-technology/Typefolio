...
export function buildFaceDescriptors(
  font: FontFile,
): FontFaceDescriptors {
...
export const SPECIMEN_SAMPLES: Array<{ id: string; label: string; text: string }> = [
  ...
  },
  {
    ...
    label: "Type specimen",
    text:
      "The goal is not beauty, but legibility. Good typography makes text disappear — the reader sees the meaning, not the medium.",
  },
];
